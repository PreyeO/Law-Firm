...
const ServiceCard = ({ title, description, className }) => {
  return (
    <div
      className={`${className} md:w-[220px] 2xl:w-[300px] 2xl:h-[350px] w-[160px] card h-[200px]  shadow-md md:p-4 2xl:p-6 text-center rounded-lg mx-auto flex flex-col justify-center gap-5`}
    >
